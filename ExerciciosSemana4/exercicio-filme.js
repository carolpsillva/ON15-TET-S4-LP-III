...
function buscarFilmes(entrada) {
    if (typeof(entrada) == "string") {
        ...
        if(porTitulo.length > 0 && porGenero.length > 0) {
            console.table("--------Filmes encontrados por título--------")
            console.table(porTitulo)
            console.table("--------------------------------------")
            console.table("--------Filmes encontrados por gênero--------")
            ...
            console.table("Nenhum filme ou dado foi encontrado com a descrição digitada")
        }    
    } else {
        console.table('dado inválido')
    }
}


buscarFilmes("aventura")